<?php   										// Opening PHP tag
	...
	function fetchOrderInfo($pdo, $email, $orderNum) {
		// SQL query to retrieve all customer and order info based on form values
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		 ...
		 */
		$order_info = fetchOrderInfo($pdo, $email, $orderNum);
	}
// Closing PHP tag  ?> 
